...
<div class="max-w-7xl mx-auto">
    <div class="px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-xl rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                <form class="space-y-6" method="POST" action="{{ route('courses.update', $course->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="code" name="code" required value="{{ old('code', $course->code) }}" 
                                   class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400" 
                        ...
                        <div>
                            ...
                            <input type="number" id="credit_hours" name="credit_hours" required min="1" max="10" value="{{ old('credit_hours', $course->credit_hours) }}" 
                                   class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400" 
                        ...
                        <div>
                            ...
                            <select id="teacher_id" name="teacher_id" class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div class="flex justify-between items-center pt-6 border-t">
                        ...
                        <div class="space-x-3">
                            <a href="{{ route('courses.show', $course->id) }}" class="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-lg transition flex items-center">
