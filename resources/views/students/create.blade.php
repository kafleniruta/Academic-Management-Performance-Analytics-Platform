                ...
                <form class="space-y-6" method="POST" action="{{ route('students.store') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="roll_number" name="roll_number" required value="{{ old('roll_number') }}" 
                                   class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 placeholder-gray-400" 
                        ...
                        <div>
                            ...
                            <select id="enrollment_year" name="enrollment_year" required class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                                <option value="">Select Year</option>
                                <option value="2024" {{ old('enrollment_year') == '2024' ? 'selected' : '' }}>2024</option>
                                <option value="2023" {{ old('enrollment_year') == '2023' ? 'selected' : '' }}>2023</option>
                                <option value="2022" {{ old('enrollment_year') == '2022' ? 'selected' : '' }}>2022</option>
                                <option value="2021" {{ old('enrollment_year') == '2021' ? 'selected' : '' }}>2021</option>
                            </select>
                    ...
                    <div class="flex justify-between items-center pt-6 border-t">
                        ...
                        <div class="space-x-3">
                            <a href="{{ route('students.index') }}" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-lg transition flex items-center">
